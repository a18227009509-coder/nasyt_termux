    ...
    if [[ "$new_version" == "$version" ]]; then
        ...
        case $update_choose in
            1)
                clear
                echo "开始更新脚本"
                curl -o .nasyt/naster https://gitee.com/HA-Hoshino-Ai/nasyt_termux/raw/master/nasyt_termux.sh
                sleep 1
                while true
                do
                    chmod +x .nasyt/*
...
version_update() {
    new_version=$(curl "https://gitee.com/HA-Hoshino-Ai/nasyt_termux/raw/master/version.txt") 
}
